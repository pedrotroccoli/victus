    ...
    <div className="w-full h-full z-[3] relative">
      <div className="absolute top-0 left-0 w-full h-full z-[1]">
        <div className={cn("relative w-full h-full grid-container")}>
          <div className={cn("w-px h-full border-r border-dashed absolute top-0 left-4", borderColor)}></div>
          <div className={cn("w-px h-full border-r border-dashed absolute top-0 right-4", borderColor)}></div>
        </div>
      </div>
