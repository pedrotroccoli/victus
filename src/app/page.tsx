...
export default function Home() {
  return (
    <main
      className="bg-seasalt h-screen flex flex-col"
    >
      <Header />
      ...
      <section>
        <div className="max-w-screen-lg mx-auto flex justify-between items-center md:mt-32 px-8 md:flex-row flex-col-reverse">
          <div className='max-w-[32rem]'>
            <h1 className={`${title.className} text-2xl font-bold text-black lg:text-4xl`}>
              Controle de perfomance com toda a <u>praticidade</u> que o papel não te oferece.
            </h1>

            <p className="text-lg text-black/70 mt-4">
              Organize seus hábitos, metas e seu dia a dia de uma forma simples e prática.
            </p>

<Link href="/sign-in">            <Button className='mt-16 w-60 h-12 flex items-center justify-between' variant='outline'>
                Crie sua conta
              <LuChevronRight/>
            </Button>
</Link>
